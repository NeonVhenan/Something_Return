...
Mesh::Mesh(int indice)
{
    ...
    case 1 :
        ...
        vertices[4] =   {QVector3D( -4.0f, 0.0f, -20.0f), QVector2D(1.0f, 0.0f)};
        vertices[5] =   {QVector3D( -4.0f, 6.0f, -20.0f), QVector2D(1.0f, 0.0f)};
        vertices[6] =   {QVector3D( -4.0f, 6.0f, 0.0f), QVector2D(1.0f, 0.0f)};
        vertices[7] =   {QVector3D( -4.0f, 0.0f, 0.0f), QVector2D(1.0f, 0.0f)};

        vertices[8] =   {QVector3D( -4.0f, 6.0f, 0.0f), QVector2D(0.0f, 1.0f)};
        vertices[9] =   {QVector3D( -4.0f, 6.0f, -20.0f), QVector2D(0.0f, 1.0f)};
        vertices[10] =   {QVector3D( 4.0f, 6.0f, -20.0f), QVector2D(0.0f, 1.0f)};
        vertices[11] =   {QVector3D( 4.0f, 6.0f, 0.0f), QVector2D(0.0f, 1.0f)};

        vertices[12] =   {QVector3D( -4.0f, 0.0f, 0.0f), QVector2D(0.0f, 0.0f)};
        vertices[13] =   {QVector3D( -4.0f, 0.0f, -20.0f), QVector2D(0.0f, 0.0f)};
        vertices[14] =   {QVector3D( 4.0f, 0.0f, -20.0f), QVector2D(0.0f, 0.0f)};
        vertices[15] =   {QVector3D( 4.0f, 0.0f, 0.0f), QVector2D(0.0f, 0.0f)};
